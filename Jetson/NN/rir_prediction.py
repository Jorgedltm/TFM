...
if __name__ == '__main__':
    ...
    for algorithm in algorithms:
        ...
        loss_data = {
            ...
            "MSE spectrogram": [np.format_float_positional(small_total_loss, precision=4)],
            "MSE magnitude": [np.format_float_positional(small_amp_loss, precision=4)],
            "1-cos(y-y_) phase": [np.format_float_positional(small_pha_loss, precision=4)],
            "MSE waveform": [np.format_float_scientific(small_wav_loss, precision=4)],
            "MSE waveform 50ms": [np.format_float_scientific(small_wav_loss_50ms, precision=4)],
            "Misalignment magnitude": [np.format_float_scientific(small_missa_amp_loss, precision=4)],
            "Misalignment waveform": [np.format_float_scientific(small_missa_wav_loss, precision=4)],
            "SDR": [np.format_float_scientific(small_wav_loss, precision=4)],
            "Similarity": [np.format_float_scientific(small_similarity_metric, precision=4)]
        }
