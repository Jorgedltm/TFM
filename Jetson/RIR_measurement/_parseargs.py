...
def _parse():
    ...
    #---
    parser.add_argument("-dist","--distance",type = float, help = "Distance from mics to speaker on a straight line, units cm.", default = 100)
    #---
    ...
    #---
    parser.add_argument('--stftsel',action='store_true')
